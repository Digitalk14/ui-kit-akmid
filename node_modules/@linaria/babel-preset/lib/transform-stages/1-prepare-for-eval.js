...
function prepareForEvalSync(babel, resolveCache, codeCache, resolve, resolvedFile, options, stack = []) {
...
async function prepareForEval(babel, resolveCache, codeCache, resolve, file, options, stack = []) {
